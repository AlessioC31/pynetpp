...
void bind_spaces(pybind11::module_ &m) {
    pybind11::class_<PynetppSpace>(m, "PynetppSpace")
        .def("get_space_type", &PynetppSpace::get_space_type);

    pybind11::class_<PynetppDiscreteSpace, PynetppSpace>(m,
    ...
    pybind11::class_<PynetppBoxSpace, PynetppSpace>(m, "PynetppBoxSpace")
        .def(pybind11::init<>())
        .def(
            pybind11::init<float, float, std::vector<uint32_t>, PynetppDType>())
