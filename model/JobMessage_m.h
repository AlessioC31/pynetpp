...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const JobMsg &obj) {
    obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, JobMsg &obj) {
    obj.parsimUnpack(b);
}
...
template <>
inline loadbalancing::JobMsg *fromAnyPtr(any_ptr ptr) {
    return check_and_cast<loadbalancing::JobMsg *>(ptr.get<cObject>());
}
